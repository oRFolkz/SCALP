        ...
        <div className="flex flex-wrap -mx-4 items-center">
          <div className="w-full lg:w-5/12 px-4 mb-12 lg:mb-0">
             <div className="space-y-8">
                <h3 className="text-2xl font-bold text-[#063326] mb-8">Um Blend, Múltiplos Alvos:</h3>
                {[
                  ...
                  <div key={i} className="flex gap-4 items-center">
                    <div className="w-8 h-8 bg-[#063326] text-white flex items-center justify-center rounded-full flex-shrink-0">
